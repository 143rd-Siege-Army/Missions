...
[west, ["prom1", "T4"], ["The promethium depots are being held by the Enemy for nefarious purposes. Secure the depots in order to allow the Emperor's holy fuel to flow.", "Promethium Field", "Promethium Field"], objNull, "CREATED", 1, 0, "seize", 1] call BIS_fnc_taskCreate;

[west, ["prom2", "T4"], ["The promethium depots are being held by the Enemy for nefarious purposes. Secure the depots in order to allow the Emperor's holy fuel to flow.", "Promethium Depot", "Promethium Depot"], objNull, "CREATED", 1, 0, "seize", 1] call BIS_fnc_taskCreate;
